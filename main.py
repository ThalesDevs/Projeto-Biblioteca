...
app.include_router(livro_router.router, prefix="/livros", tags=["Livros"])
app.include_router(carrinho_router.router, prefix="/carrinho", tags=["Carrinho"])
app.include_router(pedido_router.router, prefix="/pedidos", tags=["Pedidos"])
app.include_router(usuario_router.router, prefix="/usuarios", tags=["Usuários"])
...
async def app_info():
    return {
        ...
        "routers": [
            "Auth Router (/auth)",
            "Usuário Router (/usuarios)",
            "Livro Router (/livros)",
            "Carrinho Router (/carrinho)",
            "Pedido Router (/pedidos)"
        ]
    }
